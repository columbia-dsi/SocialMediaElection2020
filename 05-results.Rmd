...
HH::likert(candidate ~ ., temp, xlab = 'Percent',
           main = list('Diverage Candidate\'s Popularity - Absolute Value', cex = 0.7), positive.order = T, col=c('#6f8df7','#f582ae'))
...
HH::likert(candidate ~ ., temp2, xlab = 'Percent',
           main = list('Diverage Candidate\'s Popularity - Percentage', cex = 0.7), positive.order = T, col=c('#6f8df7','#f582ae'))
