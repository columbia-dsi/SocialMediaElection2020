...
Foundamentaly, today's democracy allow every citizen can vote and every vote count as one.

![Vote American](imgs/vote.png)

However, does every individual knows enough about the candidates that they have to choose from?

![Candidats](imgs/candidates.jpg)
...
With the concerns of all those mysterious, we start a study using social media data to analyze current dem candidates status, and help people to understand the 2020 presidential polls.
